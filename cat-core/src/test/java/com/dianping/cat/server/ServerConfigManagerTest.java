...
public class ServerConfigManagerTest extends ComponentTestCase {
	...
	public void test() throws Exception {
		...
		String path = System.getProperty("user.dir") + "/src/test/resources/com/dianping/cat/server/server.xml";
