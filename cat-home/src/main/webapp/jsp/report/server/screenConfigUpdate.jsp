...
<a:config>
	...
	<table class="table table-striped table-condensed " id="content">
		...
		<c:forEach var="entry" items="${model.metricScreenInfo.graphs}" varStatus="status">
