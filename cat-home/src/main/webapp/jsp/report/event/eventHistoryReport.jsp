	...
	<tr style="text-align: left">
		...
		&nbsp;[&nbsp; 
			<c:choose>
				...
				<c:otherwise>
					<a href="?op=history&domain=${model.domain}&ip=${ip}&date=${model.date}&reportType=${payload.reportType}${model.customDate}">All</a>
				</c:otherwise>
			</c:choose> &nbsp;]&nbsp;
		</c:if>
		<c:forEach var="ip" items="${model.ips}">&nbsp;[&nbsp; 
   	  		<c:choose>
					...
					<c:otherwise>
						<a href="?op=history&domain=${model.domain}&ip=${ip}&date=${model.date}&reportType=${payload.reportType}${model.customDate}">${ip}</a>
					</c:otherwise>
				</c:choose>
   	 		&nbsp;]&nbsp;
			 </c:forEach>
